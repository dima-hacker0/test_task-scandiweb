...
import { MakeOptions } from "../../../../hoc/block_choose_option/block_choose_option_hoc";
...
class BlockChooseOption extends React.Component {
  ...
  render() {
    ...
    return <BlockChooseOption />;
  }
}

const BlockOptionsProductPage = MakeOptions();

const mapStateToProps = (state) => {
  return state;
};

export default connect(mapStateToProps, null)(BlockOptionsProductPage);
