...
import { addGoodToCartCreator, ChangeAmountGoodBasketCreator } from "../../../redux/basket_reducer/basket_creator";
...
class BlockOptions extends React.Component {
  constructor(props) {
    ...
    // this.increaseTheNumber = this.increaseTheNumber.bind(this);
        ...
        <div className={classes.blocButton}>
          <button
            onClick={() => {
              ...
              if (isInCart) {
                dispatch(ChangeAmountGoodBasketCreator())
              } else {
                this.addGood();
              }
            }}
