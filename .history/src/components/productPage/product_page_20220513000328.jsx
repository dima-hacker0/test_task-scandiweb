...
class ProductPage extends React.Component {
  ...
  componentDidMount() {
    ...
    client
      ...
      .then((data) => {
        ...
        this.setDefaultData(data.data.product.attributes);
  ...
  setDefaultData(options) {
    ...
    options.forEach((element) => {
      console.log(element.name, element.items[0].value);
      // console.log(element.items[0].value);
      // dispatch(setOptionsGoodCreator(element.name, element.items[0].value));
    });
  }
