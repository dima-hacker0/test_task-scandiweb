...
import { changeCategoryCreator } from "../../../redux/main_page_reducer/main_page_creator";
...
class Navigation extends React.Component {
  ...
  componentDidUpdate(prevState) {
    ...
    const { currentCategory: prevCategory } = prevState;
    ...
    const prevCategoryElement = navigation.querySelector(
      `[data-category="${prevCategory}"]`
    );
    prevCategoryElement.style.color = "black";
  ...
  componentDidMount() {
    ...
    client
      ...
      .then((result) => {
        ...
        const defaultCategory = result.data.categories[0].name;
        dispatch(changeCategoryCreator(defaultCategory));
      });
  }
